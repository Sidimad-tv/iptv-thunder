export const pl = {
  ...
  version: 'Wersja',
  appDescription: 'S!d!m@dtv-STB — Nowoczesny emulator STB i klient IPTV oparty na Tauri + React + MPV. Obsługuje portale Stalker Middleware dla telewizji na żywo, filmów i seriali.',
